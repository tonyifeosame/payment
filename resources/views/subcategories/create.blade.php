...
<div class="max-w-2xl mx-auto bg-white p-6 shadow-md rounded">
    ...
    <form action="{{ route('school.subcategories.store', ['school' => $school->slug]) }}" method="POST" class="space-y-4">
        @csrf
        ...
        <div class="flex space-x-2">
            ...
            <a href="{{ route('school.subcategories.index', ['school' => $school->slug]) }}" class="bg-gray-500 text-white px-4 py-2 rounded">Cancel</a>
        </div>
    </form>
</div>
@endsection
